...
class IAPProcessor(BaseProcessor):
    def __init__(self, spark, broadcast_vars, schema, logger) -> None: super().__init__(spark, broadcast_vars, schema, logger)
    ...
    def process_iap_purchase(self, df: DataFrame) -> None:
        ...
        write_to_postgres(df_purchase_action, f"{self.schema}.fact_purchase_action")
