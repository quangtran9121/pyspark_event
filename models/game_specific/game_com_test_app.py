...
class DimGameVersion(Base):
    ...
    __table_args__ = {"schema": "game_test_app_schema"}
...
class DimItem(Base):
    ...
    item_type_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_item_type.item_type_id"),
    )
...
class FactPurchaseAction(Base):
    ...
    user_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_user.user_id"),
    )
    version_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_game_version.version_id"),
    )
    ...
    package_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_package.package_id"),
    )
    ...
    purchase_position_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_game_position.game_position_id"),
    )
...
class FactIAP(Base):
    ...
    show_type_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_show_type.show_type_id"),
    )
    package_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_package.package_id"),
...
class FactItemTransaction(Base):
    ...
    level_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_level.level_id"),
    )
    ...
    item_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_item.item_id"),
    )
...
class FactMovieInfo(Base):
    ...
    movie_type_id = Column(
        Integer,
        ForeignKey("game_test_app_schema.dim_movie_type.movie_type_id"),
    )
