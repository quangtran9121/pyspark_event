...
class DimGameVersion(Base):
    ...
    __table_args__ = {'schema': 'game_supermarket_journey_schema'}
...
class DimItem(Base):
    ...
    item_type_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_item_type.item_type_id'))
...
class FactPurchaseAction(Base):
    ...
    user_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_user.user_id'))
    version_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_version.version_id'))
    ...
    package_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_package.package_id'))
    price = Column(Numeric(10, 2))
    currency_id = Column(Integer, ForeignKey('common_dim_schema.dim_currency.currency_id'))
    usd_price = Column(Numeric(10, 2))
    purchase_position_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_position.game_position_id'))
...
class FactIAP(Base):
    ...
    iap_position_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_position.game_position_id'))
    show_type_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_show_type.show_type_id'))
    package_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_package.package_id'))
    sequence_id = Column(Integer)
    batch_id = Column(Integer)
    timestamp = Column(DateTime)
...
class FactLevelEvent(Base):
    ...
    user_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_user.user_id'))
    version_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_version.version_id'))
    level_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_level.level_id'))
...
class FactItemTransaction(Base):
    ...
    item_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_item.item_id'))
    quantity = Column(Integer)
    game_position_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_position.game_position_id'))
    sequence_id = Column(Integer)
    batch_id = Column(Integer)
    timestamp = Column(DateTime)
...
class FactAdView(Base):
    ...
    ad_position_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_position.game_position_id'))
...
class FactPlayerAction(Base):
    ...
    user_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_user.user_id'), nullable=False)
    version_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_game_version.version_id'))
    level_id = Column(Integer, ForeignKey('game_supermarket_journey_schema.dim_level.level_id'))
