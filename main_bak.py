...
def main():
    ...
    # Read from Kafka<F11><F11>
    kafka_df = (
        spark.readStream.format("kafka")
        .option("kafka.bootstrap.servers", config_app.event.kafka_bootstrap_servers)
        # .option("subscribe", "topic_game.com.test.app")
        .option("subscribePattern", "topic_game.com.test.app")
    ...
    def foreach_batch_function(batch_df: DataFrame, batch_id: int) -> None:
        ...
        for topic in topics:
            ...
            if topic == "topic_game.com.test.app":
                ...
                game_schema = "game_test_app_schema"
